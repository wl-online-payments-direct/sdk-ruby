...
require 'ingenico/direct/sdk/domain/decrypted_payment_data'
require 'ingenico/direct/sdk/domain/mobile_payment_product320_specific_input'

module Ingenico::Direct::SDK
  module Domain

    # @attr [String] authorization_mode
    # @attr [Ingenico::Direct::SDK::Domain::DecryptedPaymentData] decrypted_payment_data
    # @attr [String] encrypted_payment_data
    # @attr [String] ephemeral_key
    # @attr [Ingenico::Direct::SDK::Domain::MobilePaymentProduct320SpecificInput] payment_product320_specific_input
    # @attr [Integer] payment_product_id
    # @attr [String] public_key_hash
    # @attr [true/false] requires_approval
    class MobilePaymentMethodSpecificInput < Ingenico::Direct::SDK::DataObject
