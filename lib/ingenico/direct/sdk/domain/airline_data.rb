...
require 'ingenico/direct/sdk/domain/airline_flight_leg'
require 'ingenico/direct/sdk/domain/airline_passenger'
...
module Ingenico::Direct::SDK
  module Domain
    ...
    # @attr [Array<Ingenico::Direct::SDK::Domain::AirlineFlightLeg>] flight_legs
    ...
    # @attr [Array<Ingenico::Direct::SDK::Domain::AirlinePassenger>] passengers
    ...
    class AirlineData < Ingenico::Direct::SDK::DataObject
      ...
      def from_hash(hash)
        ...
        if hash.key? 'flightLegs'
          ...
          hash['flightLegs'].each do |e|
            @flight_legs << Ingenico::Direct::SDK::Domain::AirlineFlightLeg.new_from_hash(e)
          end
        end
        ...
        if hash.key? 'passengers'
          ...
          hash['passengers'].each do |e|
            @passengers << Ingenico::Direct::SDK::Domain::AirlinePassenger.new_from_hash(e)
          end
        end
