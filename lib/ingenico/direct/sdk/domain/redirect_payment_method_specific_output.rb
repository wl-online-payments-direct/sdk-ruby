...
require 'ingenico/direct/sdk/domain/payment_product5402_specific_output'
require 'ingenico/direct/sdk/domain/payment_product5500_specific_output'
require 'ingenico/direct/sdk/domain/payment_product840_specific_output'
...
module Ingenico::Direct::SDK
  module Domain
    ...
    # @attr [Ingenico::Direct::SDK::Domain::PaymentProduct5402SpecificOutput] payment_product5402_specific_output
    # @attr [Ingenico::Direct::SDK::Domain::PaymentProduct5500SpecificOutput] payment_product5500_specific_output
    # @attr [Ingenico::Direct::SDK::Domain::PaymentProduct840SpecificOutput] payment_product840_specific_output
    # @attr [Integer] payment_product_id
    # @attr [String] token
    class RedirectPaymentMethodSpecificOutput < Ingenico::Direct::SDK::DataObject
