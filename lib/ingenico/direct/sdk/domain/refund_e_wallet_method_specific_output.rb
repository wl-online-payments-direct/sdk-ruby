...
require 'ingenico/direct/sdk/domain/refund_payment_product840_specific_output'

module Ingenico::Direct::SDK
  module Domain

    # @attr [Ingenico::Direct::SDK::Domain::RefundPaymentProduct840SpecificOutput] payment_product840_specific_output
    # @attr [Long] total_amount_paid
    # @attr [Long] total_amount_refunded
    class RefundEWalletMethodSpecificOutput < Ingenico::Direct::SDK::DataObject
