...
require 'ingenico/direct/sdk/domain/customer_account_authentication'
require 'ingenico/direct/sdk/domain/customer_payment_activity'
require 'ingenico/direct/sdk/domain/payment_account_on_file'

module Ingenico::Direct::SDK
  module Domain

    # @attr [Ingenico::Direct::SDK::Domain::CustomerAccountAuthentication] authentication
    ...
    # @attr [Ingenico::Direct::SDK::Domain::PaymentAccountOnFile] payment_account_on_file
    # @attr [Ingenico::Direct::SDK::Domain::CustomerPaymentActivity] payment_activity
    class CustomerAccount < Ingenico::Direct::SDK::DataObject
      ...
      def from_hash(hash)
        ...
        if hash.key? 'authentication'
          ...
          @authentication = Ingenico::Direct::SDK::Domain::CustomerAccountAuthentication.new_from_hash(hash['authentication'])
        end
        ...
        if hash.key? 'paymentAccountOnFile'
          ...
          @payment_account_on_file = Ingenico::Direct::SDK::Domain::PaymentAccountOnFile.new_from_hash(hash['paymentAccountOnFile'])
        end
        if hash.key? 'paymentActivity'
          ...
          @payment_activity = Ingenico::Direct::SDK::Domain::CustomerPaymentActivity.new_from_hash(hash['paymentActivity'])
        end
      end
    end
  end
