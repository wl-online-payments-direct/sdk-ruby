module Ingenico::Direct::SDK
  module Webhooks
    ...
    # @attr [Ingenico::Direct::SDK::Domain::PayoutResponse] refund
    # @attr [Ingenico::Direct::SDK::Domain::RefundResponse] payout
    # @attr [Ingenico::Direct::SDK::Domain::TokenResponse] token
    # @attr [Ingenico::Direct::SDK::Domain::DisputeResponse] dispute
    class WebhooksEvent < Ingenico::Direct::SDK::DataObject
