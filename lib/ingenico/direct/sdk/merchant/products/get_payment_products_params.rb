...
module Ingenico::Direct::SDK
  module Merchant
    module Products
      ...
      # Query parameters for {https://support.direct.ingenico.com/documentation/api/reference#operation/GetPaymentProducts Get payment products}
      ...
      class GetPaymentProductsParams < Ingenico::Direct::SDK::ParamRequest
