...
module Ingenico::Direct::SDK
  module Merchant
    module Products
      ...
      # Query parameters for {https://support.direct.ingenico.com/documentation/api/reference#operation/GetPaymentProductNetworks Get payment product networks}
      # @attr [String] country_code
      # @attr [String] currency_code
      # @attr [Integer] amount
      # @attr [true/false] is_recurring
      class GetPaymentProductNetworksParams < Ingenico::Direct::SDK::ParamRequest
