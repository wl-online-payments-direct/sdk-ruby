...
describe 'MetaDataProvider' do
  ...
  MetaDataProvider ||= OnlinePayments::SDK::MetaDataProvider
  ...
  it 'can give meta_data_headers with a full shopping cart' do
    ...
    server_meta_info = OnlinePayments::SDK::DefaultImpl::DefaultMarshaller.INSTANCE.unmarshal(server_meta_info_json, MetaDataProvider::ServerMetaInfo)
  ...
  it 'refuses headers marked as prohibited' do
    MetaDataProvider.PROHIBITED_HEADERS.each do |name|
      ...
      expect { MetaDataProvider.new('OnlinePayments', additional_request_headers: additional_headers) }
