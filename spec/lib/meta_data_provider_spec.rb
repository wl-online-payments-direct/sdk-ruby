...
describe 'MetaDataProvider' do
  ...
  MetaDataProvider ||= Ingenico::Direct::SDK::MetaDataProvider
  RequestHeader ||= Ingenico::Direct::SDK::RequestHeader

  it 'can give meta_data_headers with a full shopping cart' do
    shopping_cart_extension = Ingenico::Direct::SDK::Domain::ShoppingCartExtension.new('Ingenico.creator', 'Extension', '1.0', 'ExtensionId')
    ...
    server_meta_info = Ingenico::Direct::SDK::DefaultImpl::DefaultMarshaller.INSTANCE.unmarshal(server_meta_info_json, MetaDataProvider::ServerMetaInfo)
  ...
  it 'can give meta_data_headers with a full shopping cart without an extension id' do
    shopping_cart_extension = Ingenico::Direct::SDK::Domain::ShoppingCartExtension.new('Ingenico.creator', 'Extension', '1.0')
    meta_data_provider = MetaDataProvider.new('Ingenico', shopping_cart_extension: shopping_cart_extension)
