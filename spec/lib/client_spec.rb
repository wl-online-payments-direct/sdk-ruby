...
describe 'Client' do
  ...
  it 'should not close idle connections of an unpooled connection' do
    ...
    expect(communicator.connection).to_not receive(:close_idle_connections)
  ...
  it 'should close idle connections of a pooled connection' do
    ...
    expect(communicator.connection).to receive(:close_idle_connections).with(0.500)
  ...
  it 'should not close expired connections of an unpooled connection' do
    ...
    expect(communicator.connection).to_not receive(:close_expired_connections)
  ...
  it 'should close expired connections of a pooled connection' do
    ...
    expect(communicator.connection).to receive(:close_expired_connections)
