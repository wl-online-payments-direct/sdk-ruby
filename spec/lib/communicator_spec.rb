...
Communicator ||= Ingenico::Direct::SDK::Communicator
...
describe Communicator do
  ...
  let(:communicator) { Communicator.new('https://payment.preprod.direct.ingenico.com', connection, authenticator, meta_data_provider, DefaultMarshaller.INSTANCE) }
  ...
  context 'to_absolute_uri()' do
    it 'accepts a uri with or without a leading slash' do
      ...
      expect(uri1.to_s).to eq('https://payment.preprod.direct.ingenico.com:443/v2/merchant/1234/services/testconnection')
      expect(uri2.to_s).to eq('https://payment.preprod.direct.ingenico.com:443/v2/merchant/1234/services/testconnection')
    end
    ...
    it 'adds request parameters to the uri' do
      ...
      expect(uri.to_s).to eq('https://payment.preprod.direct.ingenico.com:443/v2/merchant/1234/services/testconnection'\
